...
function install() {
  ...
  if (errors === 0) {
    ...
    console.log('  ' + c('blue', '/jr-worklist') + '         → Documento QA → worklist punto por punto');
    ...
    console.log('  ' + c('blue', '/jr-drift') + '            → Detectar divergencia specs ↔ código (read-only)');
...
function showHelp() {
  ...
  console.log('  /jr-worklist       Documento QA → worklist trackeada, un punto a la vez');
  ...
  console.log('  /jr-drift          Detectar divergencia entre specs y su código (read-only)');
